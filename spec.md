...
This file contains the Rockstar Language Specification supported by Rocky (Version 14.08.2020.) 
There are also [extensions](spec_ext.md) that are specific to Rocky. The most recent version can be found [here](https://github.com/RockstarLang/rockstar/blob/master/spec.md).
